...
public class WalletService: ServiceBase {
    ...
    public func createDidWebDoc(request: Services_Universalwallet_V1_CreateDidWebDocRequest) throws -> Services_Universalwallet_V1_CreateDidWebDocResponse {
        try client!.CreateDidWebDoc(request, callOptions: buildMetadata(request))
            .response
            .wait()
    }
