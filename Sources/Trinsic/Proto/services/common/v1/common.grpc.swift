...
extension Services_Common_V1_CommonClientProtocol {
...
extension Services_Common_V1_CommonProvider {
  public var serviceName: Substring { return "services.common.v1.Common" }
